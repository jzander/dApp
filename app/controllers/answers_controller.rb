class AnswersController < ApplicationController
  before_action :get_decision, :check_security
    ...
    def create
      ...
      if @answer.save
        redirect_to root_path(@decision.id)
      end



      # Decision.criteria.each do |a|
      #   criteriaforanswer.new
      #   criteriaforanswer.answer_id = answer.id
      #   criteriaforanswer.text = a.text
      #   criteriaforanswer.save
      # end
